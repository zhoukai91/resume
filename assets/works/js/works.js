angular.module('work', ['ng', 'ngRoute', 'ngAnimate']).
...
controller('myorderCtrl',function($scope,$http){
  $http.get('./assets/works/woele/data/orde_list.json').success(function(data){
...
config(function ($routeProvider) {
  ...
  when('/main', {
    templateUrl: './assets/works/woele/tpl/main.html',
    controller: 'mainCtrl'
  }).
  when('/detail/:did', {
    templateUrl: './assets/works/woele/tpl/detail.html',
    controller: 'detailCtrl'
  }).
  when('/order/:did', {
    templateUrl: './assets/works/woele/tpl/order.html',
    controller: 'orderCtrl'
  }).
  when('/myorder',{
    templateUrl: './assets/works/woele/tpl/myorder.html',
